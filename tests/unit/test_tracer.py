...
from CrisisWorld.schemas.episode import EpisodeTrace, LogEvent
...
class TestEpisodeTracer:
    ...
    def test_record_after_finalize_raises(self) -> None:
        from CrisisWorld.tracing.tracer import EpisodeTracer, TracerFinalizedError
    ...
    def test_save_delegates_to_serializer(self, tmp_path: object) -> None:
        ...
        from CrisisWorld.tracing.serializer import load_trace
        from CrisisWorld.tracing.tracer import EpisodeTracer
